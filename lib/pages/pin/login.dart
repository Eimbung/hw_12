...
import 'package:hw_12/pages/home/home_p.dart';
      ...
      child: Container(
        ...
        child: OutlinedButton(
            ...
            onPressed: () {
              if (num == -1) {
              ...
              }if(_pass.length==6 && _pass != '231023'){
                ...
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      ...
                      return AlertDialog(
                        title: Text('รหัสผ่านผิดพลาด',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
                        content: Text(
